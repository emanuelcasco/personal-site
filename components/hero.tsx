...
const COOL_WORDS_LIST = 'Developer, Software Developer,Geek,Software Architect,Frontend Developer,Backend Developer,Tech Lead,Software Architect,Lead Developer,Tester,Analyst,Writer,Blogger,Node.js Lover'.split(
  ','
);
      ...
      <div className="relative pb-32 px-5 xl:px-0 mx-auto grid lg:grid-cols-1 xl:grid-cols-2 xl:my-20 gap-8">
        ...
        <div className="relative hidden xl:block">
          <img
            loading="lazy"
            decoding="async"
            className="md:w-full lg:w-5/6 absolute top-24 right-0 -ml-24"
            src="/assets/logo.png"
          />
        </div>
      </div>
